# Bubble Tea Landing Page

## Overview
A minimal landing page that displays only the text "Bubble Tea" in a clean, elegant layout.
...
- Frontend-only application (no backend data storage needed)
- Static content with no dynamic functionality
- Responsive design for mobile and desktop viewing
- Fast loading with minimal resources

## Content
- Primary text: "Bubble Tea"
- Language: English
- No additional content, navigation, or interactive elements
